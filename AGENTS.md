# Sourcing Lab USA business guardrails

## Business model immutability
...
delivery responsibilities must be confirmed per order.

## Claims that are prohibited unless documented and operational

Do not claim existing U.S. operations, customers, offices, employees,
warehouses, inventory, certified inspections, customs brokerage, freight
forwarding, or regulatory certification.

Quality follow-up means production coordination and order-specific checkpoints.
It must not be presented as an independent certified inspection service.

The China sourcing relationship is an established independent partnership, not
a Sourcing Lab USA-owned factory network or a U.S. employee team.

Never publish client identities, results, savings, lead times, photos,
certifications, or compliance claims without documented proof and approval.
...
current capabilities from planned U.S. operations for 2027.
