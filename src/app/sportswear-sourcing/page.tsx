...
const page: ServicePageContent = {
  ...
  faqs: [
    ...
    { question: 'What is the minimum order quantity for sportswear?', answer: 'Minimum order quantities commonly start around 500 units, and the real figure follows the garment, fabric, construction, decoration and the split across sizes and colors. Send your estimated size and color breakdown so the available options can be reviewed against that.' },
