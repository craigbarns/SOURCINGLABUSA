...
const faqs = [
  {
    question: '¿Solo realizan sourcing de empaques?',
    answer:
      'No. Nuestro enfoque inicial son los empaques y productos textiles personalizados para marcas y empresas de comercio electrónico.',
  },
  {
    question: '¿Dónde están ubicados?',
    answer:
      'Sourcing Lab USA está preparando su lanzamiento en EE.UU. desde Miami para 2027, respaldado por una alianza establecida de sourcing en China.',
  },
  {
    question: '¿Pueden trabajar a partir de un diseño o muestra existente?',
    answer:
      'Sí. Envíe su briefing, imágenes de referencia, dimensiones, cantidad y cronograma. Confirmaremos lo que se puede cotizar y muestrear.',
  },
  {
    question: '¿Quién gestiona los requisitos de cumplimiento e importación?',
    answer:
      'Los requisitos dependen del producto exacto y el destino. Las especificaciones, certificados y términos de envío se confirman antes de la producción.',
  },
];

export function MarketingSectionsES() {
  return (
    <>
