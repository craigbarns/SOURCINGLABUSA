        ...
        <section className="border-b border-white/[0.07] py-20 sm:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <figure className="service-photo">
              ...
              />
              <figcaption>
                Product possibilities · AI-created concept imagery
              </figcaption>
            </figure>
            <div className="mt-12 grid items-end gap-10 lg:grid-cols-[1.15fr_0.75fr]">
              ...
              <aside className="surface-panel rounded-[26px] p-7 sm:p-8">
                ...
                <p className="mt-3 text-sm leading-7 text-[#98a69e]">
                  A practical brief lets us confirm the product scope before
                  discussing options, sampling, and order terms.
                </p>
                <ul className="mt-6 space-y-3">
                  {page.briefItems.map((item) => (
                    <li
                      key={item}
                      className="flex items-start gap-3 text-sm leading-6 text-[#d4ddd7]"
                    >
                      <CheckCircle2
                        className="mt-1 h-4 w-4 shrink-0 text-[#70e1b2]"
                        aria-hidden="true"
                      />
                      {item}
                    </li>
        ...
        <section className="py-20 sm:py-28">
          <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.7fr_1fr] lg:px-8">
            <div>
              ...
              <p className="mt-5 max-w-xl text-base leading-7 text-[#98a69e]">
                {page.overview}
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {page.focusAreas.map((area) => (
                <article
                  key={area.title}
                  className="bento-card rounded-[22px] p-6 sm:p-7"
                >
                  <PackageCheck
                    className="h-5 w-5 text-[#70e1b2]"
                    aria-hidden="true"
                  />
                  <h3 className="mt-6 text-lg font-bold text-white">
                    {area.title}
                  </h3>
                  <p className="mt-3 text-sm leading-6 text-[#95a199]">
                    {area.body}
                  </p>
                </article>
              ))}
        ...
        <section className="border-y border-white/[0.07] bg-[#0a0e0c] py-20 sm:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-6 text-balance text-3xl font-black tracking-[-0.045em] text-white sm:text-5xl">
                Move from a product brief to an approved order with fewer
                assumptions.
              </h2>
            </div>
            ...
            <ol className="mt-14 grid gap-4 md:grid-cols-3">
              {page.workflow.map((step, index) => (
                ...
                >
                  <FileText
                    className="h-5 w-5 text-[#c7ff6b]"
                    aria-hidden="true"
                  />
                  <h3 className="mt-8 text-lg font-bold text-white">
                    {step.title}
                  </h3>
                  <p className="mt-3 text-sm leading-6 text-[#94a198]">
                    {step.body}
                  </p>
                </li>
              ))}
                ...
                {page.relatedPages.map((related) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <h3 className="text-base font-bold text-white group-hover:text-[#dfffab]">
                          {related.title}
                        </h3>
                      ...
                      <ArrowRight
                        className="mt-1 h-4 w-4 shrink-0 text-[#c7ff6b]"
                        aria-hidden="true"
                      />
                    </div>
                  </Link>
            ...
            <div className="divide-y divide-white/[0.08] border-y border-white/[0.08]">
              {page.faqs.map((faq) => (
                <article key={faq.question} className="py-6 sm:py-7">
                  ...
                  <p className="mt-3 text-sm leading-7 text-[#94a198]">
                    {faq.answer}
                  </p>
                </article>
              ))}
